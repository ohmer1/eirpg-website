...
class ew_classement {
	/**
	 * Même chose que si dessus mais en mode Flop à condition que le mode Top de soit pas actif.
	 *
	 * @var integer
	 */
	private $flop;
	...
	/**
	 * Nombre de personnage par page - la class ew_paginate doit déjà être incluse.
	 *
	 * @var integer
	 */
	private $maxPersos;
	...
	/**
	 * Passe en mode Top si sa valeur est > 0 et affiche cette quantité de personnages.
	 *
	 * @var integer
	 */
	private $top;
	...
	/**
	 * Ordre de tri : asc(endant) ou desc(endant).
	 *
	 * @var string
	 */
	private $order;
	...
	/**
	 * Préfixe de la base de donnée de eIRPG.
	 *
	 * @var string
	 */
	private $prefix;
	...
	/**
	 * Critère de trie : id, nom, class, niveau, ttl et so.
     *
	 * @var string
	 */
	private $sort;
	...
	/**
	 * Tableau contenant les flèches - texte ou image... Clés à définir : up, down et class.
     *
	 * @var array
	 */
	private $arrows;
	...
	/**
     *Tableau contenant les templates... Clés à définir : start, items, end ; Facultatives : pagination et nbpersos.
     *
	 * @var array
	 */
	private $tplList;
	...
	/**
	 * Référence vers l'objet de la base de donnée.
     *
	 * @var object
	 */
	private $db;
