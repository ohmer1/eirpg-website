...
| Partir du canal        | `200*(<?php echo $this->ew_config->mod_penalites->expPenalite ?>ˆNIVEAU)`              |
| Quitter le serveur IRC | `30*(<?php echo $this->ew_config->mod_penalites->expPenalite ?>ˆNIVEAU)`               |
| Se déconnecter du bot  | `20*(<?php echo $this->ew_config->mod_penalites->expPenalite ?>ˆNIVEAU)`               |
| Parler sur le canal    | `LONGUEUR_MESSAGE*(<?php echo $this->ew_config->mod_penalites->expPenalite ?>ˆNIVEAU)` |
| Notice sur le canal    | `LONGUEUR_MESSAGE*(<?php echo $this->ew_config->mod_penalites->expPenalite ?>ˆNIVEAU)` |
| Être kické du canal    | `250*(<?php echo $this->ew_config->mod_penalites->expPenalite ?>ˆNIVEAU)`              |
